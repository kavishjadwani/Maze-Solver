...
public class MazeFrame extends JFrame {
     ...
     *
     * @param mazeData for details about what should be in this array see class
     * comments in Maze.java
     * @param entryLoc the entry location of the maze
     * @param exitLoc the "exit" location of the maze PRE: 0 <=
     * entryLoc.getRow() < mazeData.length and 0 <= entryLoc.getCol() <
     * mazeData[0].length and 0 <= exitLoc.getRow() < mazeData.length and 0 <=
